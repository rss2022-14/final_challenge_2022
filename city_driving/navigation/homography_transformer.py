...
PTS_IMAGE_PLANE = [[458, 248],
                   [317, 251],
                   [302, 300],
                   [505, 295]] # dummy points
######################################################
...
TEST_IMAGE_PT = ConeLocationPixel()
TEST_IMAGE_PT.u = 298
TEST_IMAGE_PT.v = 364
...
if __name__ == "__main__":
    ...
    #homography_transformer.cone_detection_callback(TEST_IMAGE_PT)
    rospy.spin()
